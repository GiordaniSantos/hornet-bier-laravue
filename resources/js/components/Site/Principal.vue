            ...
            <div class="row justify-content-center">
                ...
                <div class="col-md-6 col-lg-4 mb-5">
                    <div class="portfolio-item mx-auto" data-bs-toggle="modal" data-bs-target="#servicoModal3">
                        ...
                        <img class="img-fluid" src="images/servico-instalacao/foto3r.jpg" alt="..." style="max-height: 330px;"/>
                    </div>
                    <div><br>
                        <a href="#" data-bs-toggle="modal" data-bs-target="#servicoModal3" target="_blank" style="text-decoration: none;text-align: center;color: #ffffff;margin-top: 10px;">
    ...
    <section class="page-section mb-0" id="sobre">
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-4 me-auto"><p class="lead">Nossos Valores<br>
                    • Respeito nas relações<br>
                    • Honestidade<br>
                    • Agilidade com competência<br>
                    • Confiança<br>
                    • Comprometimento com excelência<br>
                    • Empatia<br>
                    </p>
                </div>
            </div>
